#ifndef SRC_METHOD_THREAD_H
#define SRC_METHOD_THREAD_H
...
static void method_thread_child() {
    ...
    CHECK_EQ(pthread_setcancelstate(PTHREAD_CANCEL_DISABLE, &oldstate) == 0);
    CHECK_EQ(pthread_setcanceltype(PTHREAD_CANCEL_DEFERRED, &oldtype) == 0);
}
